...
def test_customer_can_add_product_to_cart(
    ...
    quantity_input = customer_page.get_by_role("spinbutton", name="Product quantity")
    ...
    # Locators in Cart page
    cart_cell_product_data = customer_page.get_by_role("cell", name=product_name)
    cart_product_link = cart_cell_product_data.get_by_role("link", name=product_name)
    ...
    cart_item_total = customer_page.get_by_role("cell", name=f"${expected_item_total}")
    ...
    customer_page.get_by_role("textbox", name="Email address").fill(customer["email"])
    ...
    customer_page.get_by_role("textbox", name="City").fill(customer["billing"]["city"])
